...
router.post("/", async (req, res) => {
  try {
    ...
    console.log(`✅ Consulta de contacto enviada desde: ${sanitizedData.email}`);
    ...
    <div style="max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif;">
      ...
      <div style="background: white; padding: 30px; border-left: 4px solid #667eea;">
        ...
        <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
          ...
          <p style="margin: 0 0 20px; color: #333; font-size: 16px;">${data.name}</p>
          ...
          <p style="margin: 0 0 20px; color: #333; font-size: 16px;">${data.subject}</p>
        </div>
      ...
      <div style="background: #f8f9fa; padding: 20px; text-align: center; color: #666; font-size: 12px;">
        ...
        <p style="margin: 5px 0 0;">Fecha: ${new Date().toLocaleString('es-AR', { 
    ...
    <div style="max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif;">
      ...
      <div style="background: white; padding: 30px;">
        ...
        <p style="color: #666; font-size: 16px; line-height: 1.6;">
          Hemos recibido tu consulta sobre "<strong>${data.subject}</strong>" y queremos agradecerte por ponerte en contacto con nosotros.
        </p>
        
        <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #667eea;">
          <h3 style="margin: 0 0 15px; color: #333; font-size: 18px;">Resumen de tu consulta:</h3>
          <p style="margin: 0 0 10px; color: #666;"><strong>Asunto:</strong> ${data.subject}</p>
          <p style="margin: 0 0 10px; color: #666;"><strong>Email:</strong> ${data.email}</p>
          ${data.phone ? `<p style="margin: 0 0 10px; color: #666;"><strong>Teléfono:</strong> ${data.phone}</p>` : ''}
